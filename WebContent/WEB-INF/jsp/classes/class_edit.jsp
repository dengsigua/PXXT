...
<body>
	...
	<form id="classAddForm" class="itemForm" method="post" action="${pageContext.request.contextPath }/classes/editClass">
	    <table cellpadding="5">
	        <tr>
	            <td>商品类目:</td>
	            <td>
	        ...
	        <tr>
	            <td>商品标题:</td>
	            <td><input class="easyui-textbox" type="text" name="classTitle" id="classTitle" value="${cla.classTitle }" data-options="required:true" style="width: 280px;"></input></td>
	        </tr>
	        <tr>
	            <td>商品卖点:</td>
	            <td><input class="easyui-textbox" name="classSellPoint" id="classSellPoint" value="${cla.classSellPoint }" data-options="multiline:true,validType:'length[0,150]'" style="height:60px;width: 280px;"></input></td>
	        </tr>
	        <tr>
	            <td>商品价格:</td>
	            <td><input class="easyui-numberbox" type="text" name="classPrice"  id="classPrice" value="${cla.classPrice/100.00 }"  data-options="min:1,max:99999999,precision:2,required:true" />
	            </td>
	        </tr>
	...
	<div style="padding:5px">
	    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitForm()">确认修改</a>
	     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="chapterForm()">章节详情</a>
...
<script type="text/javascript">
	...
	function chapterForm(){
		...
		//$.post("${pageContext.request.contextPath }/period/init",{classId:id},null,"json");
		window.location.href = "${pageContext.request.contextPath }/period/init?classId="+id;
	}
