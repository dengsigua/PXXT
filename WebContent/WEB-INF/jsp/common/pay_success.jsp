...
<div class="take-delivery">
 <div class="status">
   ...
   <div class="successInfo">
     <ul>
       <li>付款金额<em>¥ ${orders.ordersPrice}</em></li>
       <div class="user-info">
         <p>交易学员：${student.studentName}</p>
         <p>联系电话：${student.studentTel}</p>
       </div>
             请认真核对您的交易信息，如有错误请联系客服
                               
     </ul>
     <div class="option">
       <span class="info">您可以</span>
        <a href="../person/order.html" class="J_MakePoint">查看<span>已买到的课程</span></a>
        <a href="${pageContext.request.contextPath }/common/orderinfo" class="J_MakePoint">查看<span>交易详情</span></a>
     </div>
    </div>
  </div>
</div>
