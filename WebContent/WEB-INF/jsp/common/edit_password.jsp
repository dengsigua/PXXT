...
<article class="page-container">
	<form action="${pageContext.request.contextPath }/common/edit_password2" method="post" class="form form-horizontal" id="form-change-password">
		   <input name="studentId" id="studentId" type="hidden" class="dfinput" value="${student.studentId}" />
		    ...
		    <input name="studentIntrest" id="studentIntrest" type="hidden" class="dfinput"  value="${student.studentIntrest }"/>
		     ...
		     <input name="studentPassword" id="studentPassword" type="hidden" class="dfinput" value="${student.studentPassword}" />
		  <div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>当前手机号：</label>
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text" autocomplete="off" placeholder="请输入密码" name="newpassword2" id="newpassword2" style="width: 350px;">
			</div>
		</div>
		<div class="row cl">
